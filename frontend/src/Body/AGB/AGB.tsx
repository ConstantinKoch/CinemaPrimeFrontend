	...
	render() {
		return (
			...
			<div className="aboutus_div">
                ...
                <br /> <br />
                <p className="standardParagraph" >§2 Zustandekommen eines Vertrages, Speicherung des Vertragstextes</p>
                (1) Die folgenden Regelungen über den Vertragsabschluss gelten für Bestellungen über unseren Internetshop http://www.HierNochWasEintragen.de .<br />
                <br />
                ...
                <div className="fourthParagraph">
                    1) Auswahl des Sitzplatzes und des Kinos<br /> 
                    2) Bestätigen durch Anklicken der Buttons „Order“ <br /> 
                    3) Prüfung der Angaben im Warenkorb<br /> 
                    4) Betätigung des Buttons „Checkout“ <br /> 
                    ...
                    7) Verbindliche Absendung der Bestellung durch Anklicken des Buttons  „Checkout“<br />       
                <br />
                </div>
                ...
                E-Mail zu. Die AGB können Sie jederzeit auch unter http://www.HierNochWasEintragen.de/agb.html  einsehen.

                Ihre Bestelldaten sind aus Sicherheitsgründen nicht mehr über das Internet zugänglich.
                <br /> <br />
                <p className="standardParagraph">§3 Preise, Versandkosten, Zahlung, Fälligkeit</p>
                ...
                <br />
                (2) Der Verbraucher hat die Möglichkeit der Zahlung per PayPal.<br />
                <br />
                <br />
                <p className="standardParagraph">§4 Lieferung</p>
                ...
                ************************************************
                ...
                <p className="standardParagraph">§6 Widerrufsrecht des Kunden als Verbraucher
                    ...
                    <br /> <br />
                    <p className="standardParagraph">Widerrufsbelehrung</p>
                    <br />
                <b>Widerrufsrecht</b><br />
                    ...
                    <div className="tenthParagraph">
                        Cinema Prime<br />
                        Constantin Koch<br />
                        Coblitzallee 1<br />
                        D-68163 Mannheim <br />
                        E-Mail cinemaprimedhbw@gmail.com<br />
                            </div>
                ...
                ************************************************
                ...
                <p className="standardParagraph">§7 Widerrufsformular</p>

                <p className="twelfthParagraph">Muster-Widerrufsformular</p>
                (Wenn Sie den Vertrag widerrufen wollen, dann füllen Sie bitte dieses Formular aus und senden Sie es zurück.)<br />
                <div className="thirteenthParagraph">
                An :<br />
                Cinema Prime<br />
                Constantin Koch<br />
                Coblitzallee 1<br />
                ...
                <br />
                <p className="fourteenthParagraph">§8 Gewährleistung
                </p>
                ...
                <br />
                <p className="fifteenthParagraph">§9 Verhaltenskodex</p>
                    Wir haben uns den Verhaltenskodizes der folgenden Einrichtungen unterworfen:
                    <br />
                <p className="sixteenthParagraph">
                ...
                <br />
                <p className="seventeenthParagraph">§10 Vertragssprache</p>
